...
- ⏳ **T054**: The Corroboration Window, and the Axis That Never Votes
  ...
  - *Acceptance*: replay first — 4 real starts kept and 22 phantoms lost over this log, re-checked against the 2026-09-10 sporting-ride log and the 2026-09-03 kitchen logs — then an idle evening with **zero** starts (T049 §5 run 1, never yet passed on any build) and a Karoo-paired ride starting within 60 s **with `bdate` present**.
